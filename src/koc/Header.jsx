...
export default function Header({ activeTab, onNavigate, userRole }) {
  
  const allNavItems = [
    { label: '任務管理', key: 'home', isKocOnly: true },
    { label: '代言申請區', key: 'apply', isKocOnly: true }, // 🟢 這裡改回 'apply'
    { label: '收益管理', key: 'earnings', isKocOnly: true },
  ...
  const getActiveKey = (tab) => {
    ...
    if (tab === 'apply') return 'apply'; // 🟢 這裡也要確保是 'apply'
    return '';
  };
