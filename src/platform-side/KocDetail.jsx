...
export default function KocDetail({ setCurrentPage, koc }) {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-6">
      {/* 修改：返回 user 列表 */}
      <button onClick={() => setCurrentPage('user')} className="text-gray-500 hover:text-black mb-4 flex items-center">⬅️ 返回用戶列表</button>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600"><span className="font-medium text-gray-400">已完成任務：</span> {koc.completedTasks || 0} 件</p>
