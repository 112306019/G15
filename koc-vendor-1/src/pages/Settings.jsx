    ...
    <div className="max-w-2xl space-y-6">
      <Section icon={Building2} title="廠商資訊">
        <div className="space-y-4">
          <Input label="公司名稱" defaultValue="美好肌膚股份有限公司" />
          <Input label="統一編號" defaultValue="12345678" />
          <Input label="聯絡 Email" type="email" defaultValue="contact@beauty-skin.com" />
          <Input label="公司網址" type="url" defaultValue="https://beauty-skin.com" />
